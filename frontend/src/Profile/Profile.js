...
class Profile extends React.Component {
  ...
  createUI(){
    return this.state.mpg1.map((el, i) => (
      <div className = 'Profile' key={i+1}>
        <h3>Car {i+1}</h3>
        <h5>Current Emissions</h5>
        <p>What is the average amount of miles driven by this vehicle per week?</p>
        <input  type='number' placeholder="0" name="Miles_Driven" value={el.Miles_Driven||''} onChange={this.handleChange.bind(this, i)} />
        <p>How many miles does this car get to the gallon?</p>
        <input type='number' placeholder="0" name="Miles_Per_Gallon" value={el.Miles_Per_Gallon||''} onChange={this.handleChange.bind(this, i)} />
        <p></p>
